...
class SystemContainer extends Nette\DI\Container
{
	...
	public $classes = array(
		'nette\\object' => FALSE, //: nette.cacheJournal, cacheStorage, nette.httpRequestFactory, httpRequest, httpResponse, nette.httpContext, session, nette.userStorage, user, application, nette.presenterFactory, nette.mailer, nette.database, ulohyRepository, userRepository, authenticator, container,
		...
		'spravaregistratury\\repository' => FALSE, //: ulohyRepository, userRepository,
